...
class CafeForm(FlaskForm):
    ...
    open = StringField('Opening Time', render_kw={"placeholder": "8AM"}, validators=[DataRequired()])

    close = StringField('Closing Time', render_kw={"placeholder": "6PM"}, validators=[DataRequired()])
